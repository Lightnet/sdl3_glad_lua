...
// Lua: module_gl.init() -> bool, err_msg (unchanged)
static int gl_init(lua_State *L) {
    ...
    if (!gladLoadGL((GLADloadfunc)SDL_GL_GetProcAddress)) {
        ...
        SDL_GL_DestroyContext(context);  // SDL3: Destroy, not Delete
        return 2;
    }
...
// New: module_gl.swap_buffers() -> void
...
static const struct luaL_Reg gl_lib[] = {
    ...
    {"swap_buffers", gl_swap_buffers},  // New
    {NULL, NULL}
};
